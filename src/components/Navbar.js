...
import { FiShoppingCart, FiHeart, FiBell, FiMenu, FiX, FiUser, FiSearch } from 'react-icons/fi';
  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-icons">
        ...
        <FiUser className="nav-icon" title="Profile" onClick={() => navigate('/dashboard')} style={{cursor:'pointer'}} />
        <Link to="/login">
